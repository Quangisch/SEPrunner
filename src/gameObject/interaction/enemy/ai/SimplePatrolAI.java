...
//			//getEnemy().applyInteraction(walkStyle);
////			getEnemy().getBodyObject().getSensors().get(1).setActive(!getEnemy().getAnimationObject().isFlipped());//deaktiviert rechten sensor
////			getEnemy().getBodyObject().getSensors().get(0).setActive(getEnemy().getAnimationObject().isFlipped());
//		}
//
//		//BEWEGUNGSABFOLGE
